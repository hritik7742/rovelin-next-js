      ...
      <div className="b64img-articles">
        ...
        <div className="b64img-faq">
          ...
          <div className="b64img-faq-item">
            ...
            <p>
              While there's no strict limit, we recommend keeping images under 1MB when converting 
              to Base64 to avoid performance issues and large file sizes.
            </p>
          </div>
          <div className="b64img-faq-item">
            <h3>Which image formats are supported?</h3>
            <p>
              Our tool supports all common image formats including JPG, PNG, GIF, WebP, and SVG. 
              The output will maintain the original format's quality and characteristics.
            </p>
          </div>
        </div>
      </div>
