...
import { converterVariants } from './image-converter/converterConfigs';
import './tools.css';
import { 
  FileText, 
  Image, 
...
export default function ToolsPage() {
  ...
  const filterTools = (tools: any[], query: string) => {
        ...
        <div key={category}>
          ...
          <div className="tools-grid">
            {categoryTools.map((tool, index) => (
              <Link href={tool.path} key={index} className="tool-card">
