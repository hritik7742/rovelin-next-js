      ...
      <div className="pdf-converter-workspace">
        <div className="pdf-converter-header">
          ...
          <p className="pdf-converter-description">
            Convert PDF pages to high-quality JPG images with customizable quality settings. Upload your PDF and get individual JPG files or download all as a ZIP.
          </p>
        </div>
        ...
        {loading && (
          <div className="pdf-converter-progress">
            ...
            <p className="pdf-converter-progress-text">Converting PDF pages to JPG...</p>
          </div>
        )}

        {file && !loading && images.length === 0 && (
          <div className="pdf-converter-controls">
            <div className="pdf-converter-quality-control">
              ...
              <input
                ...
                className="pdf-converter-quality-slider"
              />
            </div>
            <button
        ...
        <div className="pdf-converter-articles">
          <article className="pdf-converter-article">
            <h2>How to Use</h2>
            <p>Converting your PDF to JPG images is simple:</p>
            <ul>
              <li>Upload your PDF file</li>
              <li>Adjust JPG quality settings (10-100%)</li>
          ...
          <article className="pdf-converter-article">
            ...
            <ul>
              ...
              <li>Perfect for photo-heavy documents</li>
              <li>Wide compatibility across platforms</li>
              <li>Ideal for web use and sharing</li>
              <li>Customizable quality for size optimization</li>
            </ul>
          </article>
          ...
          <article className="pdf-converter-article">
            <h2>JPG vs PNG</h2>
            <ul>
              <li><strong>JPG:</strong> Smaller files, best for photos</li>
              <li><strong>PNG:</strong> Larger files, supports transparency</li>
              <li><strong>Quality:</strong> JPG allows compression control</li>
              <li><strong>Use Case:</strong> JPG for photos, PNG for graphics</li>
            </ul>
          </article>
        </div>

        <RelatedTools
          currentTool="/tools/pdf-to-jpg"
          category="PDF Tools"
          maxSuggestions={6}
        />
      </div>
