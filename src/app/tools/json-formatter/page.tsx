          ...
          <article className="info-box">
            ...
            <div className="faq-grid">
              <div className="faq-item">
                ...
                <p>
                  Valid JSON must follow specific rules: it must start with an object {} or array [],
                  use double quotes for strings, and use valid data types.
                </p>
              </div>
              <div className="faq-item">
                <h3>Why format JSON?</h3>
                <p>
                  Formatting JSON makes it human-readable and easier to debug. It helps identify
