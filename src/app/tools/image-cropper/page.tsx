            ...
            <div className="ic-main">
              <div className="ic-crop-container">
                <Cropper
                  ...
                  cropShape={SHAPES[selectedShape as keyof typeof SHAPES].cropShape}
          ...
          <article className="ic-article">
            ...
            <div className="ic-features">
              ...
              <div className="ic-feature">
                ...
                <p>
                  See your changes instantly with our live preview feature. What you see is 
                  exactly what you'll get in the final image.
                </p>
              </div>
              <div className="ic-feature">
                <h3>💾 Easy Export</h3>
