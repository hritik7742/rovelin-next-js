...
export default function DigitalSignature() {
  ...
  }, [typedText, fontFamily, fontSize, color, showGrid, clearSignature]);
    ...
    <div className="digsig-container">
      <div className="digsig-workspace">
        ...
        <div className="digsig-controls">
          ...
          <div className="digsig-pen-size-controls">
            ...
            <input
              ...
              max="10"
              value={penSize}
              onChange={(e) => handlePenSizeChange(Number(e.target.value))}
              className="digsig-range-input"
            />
          </div>
